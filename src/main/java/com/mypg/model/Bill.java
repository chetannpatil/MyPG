...
public class Bill implements Comparable<Bill>
{
	...
	public PG getBillOfPG() {
		return billOfPG;
	}

	public void setBillOfPG(PG billOfPG) {
	...
	public String toString() {
		return "Bill [billId=" + billId + ", billOf=" + billOf + ", billOfMonth=" + billOfMonth + ", dateOfRentPaid="
				+ dateOfRentPaid + ", amount=" + amount + ", roomNumber=" + roomNumber + "]";
	}*/
